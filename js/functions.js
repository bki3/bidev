...
function sliderBanner() {
	...
	sliderBanner.slick({
		...
		arrows: true,
		touchThreshold: 20,
		appendArrows: sliderBanner.next('.slick-arrows'),
		prevArrow: '<a href="javascript:;" class="slick-prev"><i class="fas fa-chevron-down"></i></a>',
		nextArrow: '<a href="javascript:;" class="slick-next"><i class="fas fa-chevron-up"></i></a>',
		responsive: [
			{
				breakpoint: 992,
				settings: {
